...
ptoSim(1).directLinearGenerator.lambda_fd = 23;          % Flux linkage of the stator d winding due to flux produced
ptoSim(1).directLinearGenerator.lambda_sq_0 = 0;
ptoSim(1).directLinearGenerator.lambda_sd_0 = ptoSim.directLinearGenerator.lambda_fd;                     
