"""
Defines the base Wave Energy Converter (WEC) device.
"""
...
class Device:
    def __init__(self, name: str, parameters: dict):
        """
        Args:
            name (str): Identifier for this WEC device.
            parameters (dict): device-specific parameters (e.g. geometry, hydrodynamic data).
        """
        self.name = name
