...
switch upper(wecModel)
    case 'RM3'
        simMechanicsFile = fullfile(wecModelPath, 'W2G_ss_RM3.slx');  % Full absolute path
    ...
    case 'LUPA'
        simMechanicsFile = fullfile(wecModelPath, 'W2G_ss_lupa.slx');  % Full absolute path
...
% Keep default caseDir for writing output files to working directory
% Store the full absolute path to the Simulink file
simu.simMechanicsFile = simMechanicsFile; % Full absolute path to package file
